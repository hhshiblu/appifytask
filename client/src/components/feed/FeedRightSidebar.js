...
export default function FeedRightSidebar() {
  return (
    							<div className="_layout_right_sidebar_wrap max-[991px]:hidden">
    									...
    									<div className="_feed_right_inner_area_card  _padd_t24  _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
    										<div className="_feed_top_fixed">
    											...
    											<form className="_feed_right_inner_area_card_form">
    												...
    												<input className="_feed_right_inner_area_card_form_inpt" type="search" placeholder="input search text" aria-label="Search" />
    											</form>
    										</div>
