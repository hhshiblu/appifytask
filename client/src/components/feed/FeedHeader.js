...
function ProfileMenuItem({ icon, label, onClick, showArrow = true }) {
  const content = (
    <>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, minWidth: 0 }}>
        <span style={MENU_ICON_STYLE}>{icon}</span>
        <span style={{ fontWeight: 500, fontSize: 16, color: '#112032', lineHeight: 1.2 }}>{label}</span>
      </div>
      {showArrow && (
        <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" fill="none" viewBox="0 0 6 10" style={{ opacity: 0.5, flexShrink: 0 }}>
...
export default function FeedHeader({ user, onThemeToggle }) {
  const router = useRouter();
  const [showNotify, setShowNotify] = useState(false);
  const [showProfile, setShowProfile] = useState(false);
  const [showMobileSearch, setShowMobileSearch] = useState(false);
  const { inputValue, setInputValue, applySearch } = useFeedSearch();
  ...
  return (
    <>
<nav className="_header_nav _padd_t10 max-[991px]:hidden">
    				<div className="_nav_custom_container _custom_container">
    					<div className="_logo_wrap">
    						<Link className="" href="/feed">
    							<img src="/assets/images/logo.svg" alt="Image" className="_nav_logo" />
    						</Link>
    					</div>
    					<button className="lg:hidden bg-bg2 p-2 rounded border border-bcolor2" type="button" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"> <span className="inline-block w-5 h-5 bg-current opacity-60"></span>
    					</button>
    					<div className="flex flex-1 flex-nowrap items-center justify-end" id="navbarSupportedContent">
    						<div className="_header_form ml-auto">
    						...
    						<ul className="_header_nav_list ml-auto _mar_r8 flex items-center mb-0">
    							<li className="_header_nav_item">
    								<Link className="_header_nav_link_active _header_nav_link" aria-current="page" href="/feed">
    							...
    							<li className="_header_nav_item">
    								<Link className="_header_nav_link" aria-current="page" href="/friend-request">
    							...
    							<li className="_header_nav_item">
    								<span className={`_header_nav_link _header_notify_btn cursor-pointer${showNotify ? " _active" : ""}`} onClick={() => setShowNotify((v) => !v)} role="button" tabIndex={0} onKeyDown={(e) => e.key === "Enter" && setShowNotify((v) => !v)}>
    									...
    									<div className={`_notification_dropdown${showNotify ? " show" : ""}`}>
    							...
    							<li className="_header_nav_item">
    								<Link className="_header_nav_link" aria-current="page" href="/chat">
    						...
    						<div
    							...
    							className="_header_nav_profile relative"
    							style={{ display: 'flex', alignItems: 'center', gap: 10, position: 'relative', flexShrink: 0 }}
    						>
    							...
    							>
    								<p className="_header_nav_para" style={{ margin: 0, whiteSpace: 'nowrap' }}>{firstName}</p>
    								<button
    									className="_header_nav_dropdown_btn _dropdown_toggle"
    									type="button"
    									
    									style={{ display: 'flex', alignItems: 'center', border: 'none', background: 'transparent', padding: 0, margin: 0 }}
    								>
    							...
    							<div className={`_nav_profile_dropdown _profile_dropdown${showProfile ? ' show' : ''}`}>
    								<div
    									style={{
    										display: 'flex',
    										alignItems: 'center',
    								...
    								>
    									...
    									<div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', minWidth: 0 }}>
    										<h4 style={{ margin: '0 0 4px 0', fontWeight: 700, fontSize: 16, lineHeight: 1.2, color: '#112032' }}>
    											{firstName}
    										</h4>
    										<Link
    											href="/profile"
    											style={{ fontSize: 14, lineHeight: 1.2, color: '#377DFF', textDecoration: 'none' }}
    										>
    											View Profile
    										</Link>
    									</div>
    								...
    								<hr style={{ border: 'none', borderTop: '1px solid #E8E8E8', margin: '0 0 8px 0' }} />

    								<ul style={{ listStyle: 'none', margin: 0, padding: '8px 0 4px 0', display: 'flex', flexDirection: 'column', gap: 4 }}>
    									<ProfileMenuItem
    										label="Settings"
    										icon={
    			...
    			<div className="_header_mobile_menu hidden max-[991px]:block">
    								...
    								<div className="w-full px-3">
    									<div className="_header_mobile_menu_top_inner">
    										...
    										<div className="_header_mobile_menu_right">
    											...
    											<div className="_header_mobile_toggle _header_mobile_toggle_top">
    												<button
    													type="button"
    													className="_header_mobile_btn_link _header_mobile_theme_btn"
    													aria-label="Toggle theme"
    													onClick={onThemeToggle}
    												>
    													<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24">
    														<path stroke="#666" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z" />
    													</svg>
    												</button>
    											</div>
    										</div>
    									...
    									{showMobileSearch && (
    										<div className="_header_mobile_search_panel">
    											<form className="_header_form_grp _header_mobile_search_form" onSubmit={handleSearchSubmit}>
    												<svg className="_header_form_svg" xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="none" viewBox="0 0 17 17">
    													<circle cx="7" cy="7" r="6" stroke="#666"/>
    													<path stroke="#666" strokeLinecap="round" d="M16 16l-3-3"/>
    												</svg>
    			...
    			<div className="_mobile_navigation_bottom_wrapper hidden max-[991px]:block">
